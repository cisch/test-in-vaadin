...
public class POIProbe {
    ...
    public static ByteArrayOutputStream getDocx() {

        try (XWPFDocument sdoc = new XWPFDocument()) {

            XWPFParagraph p1 = sdoc.createParagraph();
            System.out.println(sdoc.toString());
            XWPFRun r1 = p1.createRun();

            r1.setBold(true);
            r1.setText("The quick brown fox");
            System.out.println(r1.getFontName());
            XWPFRun r2 = p1.createRun();
            r2.setBold(false);
            r2.setColor("AA3388");
            r2.setText("is looking at you.");
            r2.setTextPosition(10);

            r2.addBreak();
            p1.setVerticalAlignment(TextAlignment.TOP); // AUTO, BASELINE, BOTTOM, Center
            r2.setFontFamily("Courier");
            r2.setCapitalized(true);
            r2.addCarriageReturn();
            r2.setText("You yOu you");
            //ByteArrayOutputStream outStream;
            try (ByteArrayOutputStream outStream = new ByteArrayOutputStream()) {
                sdoc.write(outStream);
                return outStream;
            }
            catch( IOException e){
                return null;
